...
- `.docs/extensions/diagnose.md` for extension investigation agents

Produces:
- `.docs/diagnoses/<slug>.md` (see references/diagnose-template.md)
...
Write to `.docs/diagnoses/<slug>.md` using references/diagnose-template.md.
...
Produces: `.docs/diagnoses/<slug>.md`
